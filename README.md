...
3. If you plan on setting up Docker containers using Podman and Quadlets using the scripts, run sudo install-podman-cockpit.sh and _then_ _take another snapshot_ before setting up any containers.
